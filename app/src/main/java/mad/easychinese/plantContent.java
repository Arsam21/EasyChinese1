...
public class plantContent extends Activity implements  TextToSpeech.OnInitListener {
    ...
    String textSound;
    String[] id= {"竹","枫","草","菊","兰","叶","莲","梅","葵","树"
    };
    String[] video = {"android.resource://mad.easychinese/"+R.raw.bamboo_pinyin,
            "android.resource://mad.easychinese/"+R.raw.feng_pinyin,
            "android.resource://mad.easychinese/"+R.raw.grass_pinyin,
            "android.resource://mad.easychinese/"+R.raw.juhua_pinyin,
            "android.resource://mad.easychinese/"+R.raw.lanhua_pinyin,
            "android.resource://mad.easychinese/"+R.raw.leaf_pinyin,
            "android.resource://mad.easychinese/"+R.raw.lily_pinyin,
            "android.resource://mad.easychinese/"+R.raw.mei_pinyin,
            "android.resource://mad.easychinese/"+R.raw.sunflower_pinyin,
            "android.resource://mad.easychinese/"+R.raw.tree_pinyin};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animal = getResources().getStringArray(R.array.plant);
    ...
    public void refresh(){
        ...
        imgViewImage.setImageResource(lessonDataSource.getlessonplant().get(position).getImage());
        textViewDescription.setText(lessonDataSource.getlessonplant().get(position).getDes());
